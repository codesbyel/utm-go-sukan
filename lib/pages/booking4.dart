/* THIS BOOKING PAGE 4 IS FOR STADIUM */
import 'dart:io';
...
class Booking extends State<BookingPage4> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('AZMAN HASHIM | Booking Confirmation'),
      ...
      child: RaisedButton(
       ...
       //       'amount': amount.text,
         ...
         //     'photo': photo,
            ...
            HelperService().showToast("Stadium Azman Hashim - Booking Confirmed!");

/* THIS BOOKING PAGE 2 IS FOR UTM SPORT HALL 1 */
import 'dart:io';
...
class Booking extends State<BookingPage2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('SPORT HALL 1 | Booking Confirmation'),
      ...
      child: RaisedButton(
       ...
       //       'amount': amount.text,
         ...
         //     'photo': photo,
            ...
            HelperService().showToast("Sport Hall 1 - Booking Confirmed!");
